...
resource "null_resource" "file_replacement_api_gw" {
  provisioner "local-exec" {
    command     = <<EOF
sed -i "s,API_GATEWAY_URL,${aws_api_gateway_deployment.apideploy_ba.invoke_url},g" modules/module-1/resources/s3/webfiles/build/static/js/main.8e1faa85.js
sed -i "s,API_GATEWAY_URL,${aws_api_gateway_deployment.apideploy_ba.invoke_url},g" modules/module-1/resources/s3/webfiles/build/static/js/main.8e1faa85.js.map
sed -i 's/"\/static/"https:\/\/${aws_s3_bucket.bucket_upload.bucket}\.s3\.amazonaws\.com\/build\/static/g' modules/module-1/resources/s3/webfiles/build/static/js/main.8e1faa85.js
sed -i 's/n.p+"static/"https:\/\/${aws_s3_bucket.bucket_upload.bucket}\.s3\.amazonaws\.com\/build\/static/g' modules/module-1/resources/s3/webfiles/build/static/js/main.8e1faa85.js
sed -i 's/n.p+"static/"https:\/\/s3-bucket-name\.s3\.amazonaws\.com\/build\/static/g' modules/module-1/resources/s3/webfiles/build/static/js/main.8e1faa85.js
EOF
    interpreter = ["/bin/bash", "-c"]
  }
  depends_on = [
